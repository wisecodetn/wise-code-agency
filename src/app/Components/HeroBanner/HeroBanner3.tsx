    ...
    return (
            <section className="agk-hero">
                <div className="hero-wrapper-three">
                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                ...
                                <div className="hero-content mb-70 pf_fadeup">
                                    <h1>Wise Code - <span>Digital Excellence</span> Through Innovation</h1>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <Image src="/assets/images/hero-img1.jpg" alt="img" width={1815} height={658}   />
                        ...
                        <div className="text-box">
                            <p>A <span>leading digital agency in Tunisia</span> specializing in web development, digital marketing, e-commerce solutions, and innovative strategies to accelerate your business growth and enhance online presence.</p>
                        </div>
                    </div>
                </div>
            </section>
